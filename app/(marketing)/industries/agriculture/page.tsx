  ...
  return (
    <div className="min-h-screen overflow-x-hidden" style={{ background: 'var(--color--gray-8)' }}>
      <BreadcrumbSchema items={[
            ...
            { name: 'Agriculture Traceability & Compliance', url: 'https://origintrace.trade/industries/agriculture' },
          ]} />
      <MarketingNav />
