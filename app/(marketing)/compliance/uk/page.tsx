...
<div className="min-h-screen bg-background overflow-x-hidden">
        ...
        <main>
          ...
          <section className="py-20 md:py-28" data-testid="section-who-must-comply">
          ...
          <section className="py-20 md:py-28 bg-slate-50 dark:bg-slate-900/20" data-testid="section-covered-commodities">
            <div className="max-w-6xl mx-auto px-6">
              <FadeIn>
                <div className="text-center mb-16">
                  <span className="inline-block text-xs font-semibold tracking-widest text-emerald-600 dark:text-emerald-400 uppercase mb-4">
          ...
          <section className="py-20 md:py-28" data-testid="section-due-diligence">
            <div className="max-w-6xl mx-auto px-6">
              <FadeIn>
                <div className="text-center mb-16">
                  <span className="inline-block text-xs font-semibold tracking-widest text-emerald-600 dark:text-emerald-400 uppercase mb-4">
              ...
              <StaggerContainer className="grid md:grid-cols-2 gap-6">
                {dueDiligenceRequirements.map((req) => (
                      ...
                      <CardContent className="p-6">
                        <div className="flex items-start gap-4">
                          <div className="w-12 h-12 rounded-md bg-emerald-500/10 flex items-center justify-center shrink-0">
                            <req.icon className="w-6 h-6 text-emerald-600 dark:text-emerald-400" />
                          </div>
                          <div>
                            <h3 className="text-lg font-semibold text-slate-900 dark:text-white mb-2" data-testid={`text-requirement-${req.title.toLowerCase().replace(/\s+/g, '-')}`}>
                              {req.title}
                            </h3>
                            <p className="text-sm text-slate-600 dark:text-slate-400 leading-relaxed">
                              {req.desc}
          ...
          <section className="py-20 md:py-28 bg-slate-50 dark:bg-slate-900/20" data-testid="section-how-origintrace-helps">
            <div className="max-w-6xl mx-auto px-6">
              <FadeIn>
                <div className="text-center mb-16">
                  <span className="inline-block text-xs font-semibold tracking-widest text-emerald-600 dark:text-emerald-400 uppercase mb-4">
          ...
          <section className="py-20 md:py-28" data-testid="section-timeline">
            <div className="max-w-6xl mx-auto px-6">
              <FadeIn>
                <div className="text-center mb-16">
                  <span className="inline-block text-xs font-semibold tracking-widest text-emerald-600 dark:text-emerald-400 uppercase mb-4">
          ...
          <section className="py-20 md:py-28 bg-slate-50 dark:bg-slate-900/20" data-testid="section-faq">
          ...
          <section className="py-20 md:py-28" data-testid="section-cta">
            <div className="max-w-6xl mx-auto px-6">
              <FadeIn>
                <Card>
