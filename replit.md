...
The shipment scoring engine is split into `lib/services/scoring/` directory (barrel re-export at `lib/services/shipment-scoring.ts` for backward compat). It evaluates shipments against 7 regulatory frameworks with distinct rules:
